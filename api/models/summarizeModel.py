...
class PageSummary(BaseModel):
    summary: str = Field(
        description="The summary of the page in 2-3 paragraphs")
    sections: List[str] = Field(
        description="The sections that this page is useful for")
...
summarize_chain = LLMChain(
    llm=llm, prompt=chat_prompt, output_parser=parser)
